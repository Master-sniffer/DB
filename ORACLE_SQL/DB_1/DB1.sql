...
CREATE TABLE  COUNTRIES
   (COUNTRY_ID NUMBER, 
	...
	COUNTRY_NAME VARCHAR2(70) CONSTRAINT CNAME_NN NOT NULL, 
	...
	FLAG BLOB, 
	CURRENCY_CODE VARCHAR2(7) NOT NULL, 
	CONSTRAINT CRTY_PK PRIMARY KEY (COUNTRY_ID),
        CONSTRAINT COUNTR_REG_ID_FK1 FOREIGN KEY (REGION_ID) REFERENCES  REGIONS (REGION_ID)
   );
...
CREATE TABLE  CURRENCIES 
   (CURRENCY_CODE VARCHAR2(7), 
	CURRENCY_NAME VARCHAR2(40) CONSTRAINT CURR_NN NOT NULL, 
...
CREATE TABLE  LANGUAGES
   (LANGUAGE_ID NUMBER(4,0), 
	LANGUAGE_NAME VARCHAR2(50) CONSTRAINT LANG_LANGNAME_NN NOT NULL, 
...
CREATE TABLE  SPOKEN_LANGUAGES
   (COUNTRY_ID NUMBER(4,0), 
	...
	CONSTRAINT SPOKEN_LANG_PK PRIMARY KEY (COUNTRY_ID, LANGUAGE_ID),
        CONSTRAINT CTRY_NUM_FK1 FOREIGN KEY (COUNTRY_ID) REFERENCES  COUNTRIES (COUNTRY_ID),
        CONSTRAINT LANG_ID_FK2 FOREIGN KEY (LANGUAGE_ID) REFERENCES  LANGUAGES (LANGUAGE_ID)
   );
